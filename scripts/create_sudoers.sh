...

{
  ...
  echo "Cmnd_Alias DEBIAN_BOT_DOCKER = /usr/bin/docker ps *, /usr/bin/docker start *, /usr/bin/docker stop *, /usr/bin/docker restart *, /usr/bin/docker logs *, /usr/bin/docker stats *"
  echo
